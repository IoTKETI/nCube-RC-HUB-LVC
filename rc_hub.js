    ...
    while (RCstrFromGCS.length >= RC_LENGTH) {
        ...
        if (header1 === 'ff') {
            ...
            if (flight.simul.toLowerCase() === 'off') {
                ...
                mission_value.ch8_raw = SBUS2RC(parseInt(RCData.substring(46, 48), 16));   // CH 23 - sub
                mission_value.ch9_raw = SBUS2RC(parseInt(RCData.substring(48, 50), 16));   // CH 24
                mission_value.ch10_raw = SBUS2RC(parseInt(RCData.substring(50, 52), 16));   // CH 25
                mission_value.ch11_raw = SBUS2RC(parseInt(RCData.substring(52, 54), 16));   // CH 26
                mission_value.ch12_raw = SBUS2RC(parseInt(RCData.substring(56, 58), 16));   // CH 28
                mission_value.ch13_raw = SBUS2RC(parseInt(RCData.substring(58, 60), 16));   // CH 29
                mission_value.ch14_raw = SBUS2RC(parseInt(RCData.substring(60, 62), 16));   // CH 30
                mission_value.ch15_raw = SBUS2RC(parseInt(RCData.substring(62, 64), 16));   // CH 31
                mission_value.ch16_raw = SBUS2RC(parseInt(RCData.substring(64, 66), 16));   // CH 32
